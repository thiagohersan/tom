...
Trend.create([
  ...
  { name: 'Diversidade e Inclusão', description: 'Construção de uma cultura organizacional de diverisidade e inclusão, para criar comunidades mais inovadoras através da justiça social.' },
  { name: 'Pessoas e IA', description: 'Colaboração entre humanos e Inteligência Artifical para desenvolver soluções e produzir de forma mais rápida e eficiente.' },
