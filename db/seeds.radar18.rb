...
Trend.create([
  ...
  { name: 'EMQ', description: 'Broker MQTT multiplataforma de código aberto e escalável; escrito em Erlang/OTP para melhor desempenho, lidando com milhões de conexões simultâneas.' },
  { name: 'Google Kubernetes Engine (GKE)', description: 'Solução Kubernetes gerenciada para implantação de aplicações em contêineres que aprimora a sobrecarga operacional de execução e manutenção de clusters Kubernetes. ' },
  { name: 'Helm', description: 'Gerenciador de pacotes para Kubernetes. O conjunto de recursos do Kubernetes que definem uma aplicação é empacotado como uma série de gráficos.' },
  ...
  { name: 'AssertJ', description: 'Biblioteca Java que fornece uma interface fluente para asserções, o que facilita a transmissão de intenção dentro do código de teste.' },
